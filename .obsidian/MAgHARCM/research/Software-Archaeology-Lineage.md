...
| `[[1.0.0 PRIM-3]]` | Target Skeleton-First Gen | Skel [[P-03]], ReCodeAgent; [[1.0.0 P-54]] Phi-3 Tech Report | Baldwin & Clark ([[1.0.0 P-34]]) Design Rules; [[P-42]] DSM ([[1.0.0 P-42]]); [[1.0.0 P-53]] Lost in the Middle | `internal/agents/planning.go` |
...
| `[[1.0.0 PRIM-5]]` | Test Co-Translation & Synth | Pynguin [[P-23]], ReCodeAgent; [[P-56]] Zan ([[1.0.0 P-56]]) Multi-SWE-bench | [[1.0.0 P-24 Feathers]] (2004) Characterization Tests; multilingual SLM baseline (Java/Go/Rust/C) | `internal/agents/validator.go` |
| `[[1.0.0 PRIM-6]]` | Multi-Stage Build/Test Repair | AlphaTrans [[P-02]], ReCodeAgent; [[1.0.0 P-54]] Phi-3 | Automated Program Repair (Le Goues); Phi-3 chat-format alignment for repair prompts | `internal/agents/validator.go` |
| `[[1.0.0 PRIM-7]]` | Multi-Agent Verdict Validation | MatchFixAgent [[P-08]]; [[1.0.0 P-57]] Speculative Decoding | N-Version Programming (Avizienis); [[1.0.0 P-52]] Self-Consistency; speculative draft/target for SLM fleet | `internal/agents/verdict_panel.go` |
...
| `[[1.0.0 PRIM-11]]` | Implementation-Agnostic Test | RepoMod-Bench [[P-11]]; [[P-56]] Zan ([[1.0.0 P-56]]) Multi-SWE-bench | Black-Box Specification Testing; multilingual real-issue benchmark | `internal/agents/impl_agnostic.go` |
| `[[1.0.0 PRIM-12]]` | Wasm Reference Oracle | VERT [[P-12]]; [[P-56]] Zan ([[1.0.0 P-56]]) Multi-SWE-bench | Differential Execution Oracles (McKeeman); per-language differential baseline | `internal/agents/wasm_oracle.go` |
| `[[1.0.0 PRIM-13]]` | Adversarial Test Guard | AdvTestGen [[P-25]]; [[P-56]] Zan ([[1.0.0 P-56]]) Multi-SWE-bench | Mutation Testing & Assertion Invariants, [[P-48]] Jia & [[1.0.0 P-48]] Mutation Survey; multilingual adversarial benchmark | `internal/agents/validator.go` |
| `[[1.0.0 PRIM-14]]` | Software-Archaeology Stage | pp-besm, AgentPatterns.ai; [[1.0.0 P-54]] Phi-3 | Chikofsky & Cross ([[1.0.0 P-33]]) Reverse Eng, [[P-46]] Seacord et al. ([[1.0.0 P-46]]) Modernizing Legacy Systems; Phi-3-mini-128K whole-file archaeology | `internal/agents/archaeology.go` |
...
| `[[1.0.0 PRIM-19]]` | Design Rule Hierarchy Part | Kazman et al. [[P-20]], Baldwin-Clark | Baldwin & Clark ([[1.0.0 P-34]]) Modularity, [[P-41]] 2024 retrospective, [[P-42]] MacCormack ([[1.0.0 P-42]]) DSM | `internal/agents/design_rule_hierarchy.go` |
...
| `[[1.0.0 PRIM-21]]` | Migration Strategy Selection | Müller et al. [[P-06]]; [[1.0.0 P-57]] Speculative Decoding | Legacy Migration Frameworks (Müller); [[1.0.0 P-52]] Self-Consistency (strategy-level ensemble); speculative decoding strategy registry | `internal/agents/strategy.go` |
| `[[1.0.0 PRIM-22]]` | Four Phases Comprehension | Foltz ([[1.0.0 P-40]]) [[P-30]]; canonical hop-1 [[P-40]]; [[P-51]] Cassano ([[1.0.0 P-51]]) Can It Edit; [[P-54]] Abdin ([[1.0.0 P-54]]) Phi-3; [[P-55]] Schick ([[1.0.0 P-55]]) SLM Few-Shot; [[P-56]] Zan ([[1.0.0 P-56]]) Multi-SWE-bench | Cognitive Program Comprehension (Soloway-Adelson, Pennington, Brooks, Détienne) | `internal/agents/comprehension.go` |
| `[[1.0.0 PRIM-23]]` | Chunked Translation | ChatDev [[P-12]], MetaGPT [[P-11]]; [[1.0.0 P-53]] Lost in the Middle | Bounded-Context Translation | `internal/agents/chunked_translator.go` |
| `[[1.0.0 PRIM-24]]` | SOP-Anchored Role Artifact | MetaGPT [[P-11]]; [[P-45]] Curtis-Kellner-Over ([[1.0.0 P-45]]); [[P-55]] Schick ([[1.0.0 P-55]]) SLM Few-Shot | Standard Operating Procedures (SOP); cloze reformulation as artifact schema | `internal/compiletime/compiletime.go`, `internal/agents/state.go` |
| `[[1.0.0 PRIM-25]]` | Role-Flip De-Hallucination | ChatDev [[P-12]]; sycophancy anchor [[P-38]] ([[1.0.0 P-38]] Raman); [[P-51]] Cassano ([[1.0.0 P-51]]) Can It Edit; [[P-55]] Schick ([[1.0.0 P-55]]) SLM Few-Shot | Adversarial Verification (Sycophancy Gate); SLM few-shot role-flip prompt pattern | `internal/agents/roleflip.go` |
| `[[1.0.0 PRIM-26]]` | Symbol-Aware Navigator | HyperAgent [[P-13]], ABCoder; [[P-50]] Jiang ([[1.0.0 P-50]]) Code-Gen Survey | Targeted Context Retrieval | `internal/agents/navigator.go` |
...
| `[[1.0.0 PRIM-31]]` | Iterative Retrieval Refine | RepoCoder [[P-13]]; [[1.0.0 P-53]] Lost in the Middle; [[P-56]] Zan ([[1.0.0 P-56]]) Multi-SWE-bench; [[P-57]] Leviathan ([[1.0.0 P-57]]) Speculative Decoding | Dynamic Feedback Retrieval-Augmented Gen; speculative decoding for retrieval-decoding | `internal/agents/iter_retrieval.go` |
