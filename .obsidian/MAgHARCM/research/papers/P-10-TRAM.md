...
**Cited by**: [[primitives/Primitives-Index]] entry [[PRIM-8]] (State-Grounded Mock-Based In-Isolation Validation); influences [[PRIM-10]] (Feature-Mapping & Type-Compatibility Validation) through its context-aware type-resolution step
