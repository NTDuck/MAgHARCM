...
**Cited by**: [[primitives/Primitives-Index]] entry for [[PRIM-26]] (Symbol-Aware Navigator) and the role-specialisation model behind the planner/navigator/editor/executor decomposition referenced in the appendix.
