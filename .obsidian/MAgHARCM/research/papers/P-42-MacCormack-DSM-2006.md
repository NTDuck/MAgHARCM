...
**Cited by**: [[primitives/Primitives-Index]] entry [[PRIM-3]] (Target Skeleton-First Generation) — provides the empirical Design Structure Matrix (DSM) analysis that motivates the skeleton-first synthesis order.
...
- [[primitives/Primitives-Index]] — [[1.0.0 PRIM-3]] status entry now references [[P-42]] alongside [[Baldwin-Clark-2000]] and [[ReCodeAgent]].
