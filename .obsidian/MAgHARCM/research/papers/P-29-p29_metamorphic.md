...
**Cited by**: [[primitives/INDEX]] entries [[PRIM-11]] (Implementation-Agnostic Testing — metamorphic relations as oracle), [[PRIM-12]] (Wasm-Based Reference Execution Oracle — metamorphic fallback when no oracle exists)
