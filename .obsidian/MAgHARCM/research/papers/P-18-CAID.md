...
**Cited by**: [[primitives/Primitives-Index]] entry [[PRIM-17]] (Asynchronous Software Engineering Agent Architecture); references multiple agents on a shared-memory blackboard, event-driven wake, central scheduler for conflict arbitration
