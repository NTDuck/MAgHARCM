...
**Cited by**: [[primitives/INDEX]] entry [[PRIM-15]] (Evidence-First Adaptation Pattern); references target-preserving spec, contract-before-code, provenance-aware diff, untrusted-source model
