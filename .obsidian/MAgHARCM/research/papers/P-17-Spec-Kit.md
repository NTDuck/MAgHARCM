...
**Cited by**: [[primitives/Primitives-Index]] entry [[PRIM-16]] (Spec-Driven Development Lifecycle); referenced sequence is constitution → specify → plan → tasks → implement → converge
