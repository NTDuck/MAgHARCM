...
**Cited by**: [[primitives/INDEX]] entry for [[PRIM-25]] (Communicative-De-hallucination Role-Flip Gate) — provides the empirical anchor for why a role-flipped second-pass reviewer is necessary in agent translation harnesses.
...
- [[primitives/INDEX]] — [[1.0.0 PRIM-25]] status entry points at P-38 as hop-1 alongside [[Hong-2023-MetaGPT]] (SOP contracts) and [[Qian-2023-ChatDev]] (communicative de-hallucination).
