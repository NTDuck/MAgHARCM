...
**Cited by**: [[primitives/Primitives-Index]] entries [[PRIM-1]] (Reverse Topological Translation Ordering), [[PRIM-2]] (Back-Edge-Conditioned Reverse-Topological Scheduling), [[PRIM-3]] (Target Skeleton-First Generation), [[PRIM-5]] (Test Suite Co-Translation & Synthesis), [[PRIM-6]] (Multi-Stage Build/Test Feedback Repair)
