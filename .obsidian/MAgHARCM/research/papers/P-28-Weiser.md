...
**Cited by**: [[primitives/Primitives-Index]] entries [[PRIM-2]] (Back-Edge-Conditioned Reverse-Topological Scheduling — data-flow preconditioning), [[PRIM-9]] (Tri-Representation Hybrid Code Graph — slicing layer for PDG/SDG)
