...
**Cited by**: [[primitives/Primitives-Index]] entry not formally assigned, but the methodology ledger reuses CodePlan's planning backbone for [[PRIM-1]] (Reverse Topological Translation Ordering), [[PRIM-23]] (Chunked Translation), [[PRIM-29]] (Recruitment-Adaptive Planning).
