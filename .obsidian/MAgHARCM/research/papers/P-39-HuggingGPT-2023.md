...
**Cited by**: [[primitives/Primitives-Index]] entry [[PRIM-29]] (Recruitment-Adaptive Planning) — provides the task-graph model the Recruiter uses to plan re-configuration.
...
- [[primitives/Primitives-Index]] — [[1.0.0 PRIM-29]] status entry points at P-39 as the controller-expert hop-1, alongside P-26 (AgentVerse) for dynamic-roster hop-1.
