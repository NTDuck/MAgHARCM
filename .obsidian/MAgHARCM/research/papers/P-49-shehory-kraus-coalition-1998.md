...
**Cited by**: [[primitives/INDEX]] entry [[PRIM-29]] (Recruitment-Adaptive Planning) — provides the canonical hop-1 academic reference for dynamic multi-agent coalition formation and task allocation.
...
- [[primitives/INDEX]] — [[1.0.0 PRIM-29]] status entry now references [[P-49]] alongside [[P-26]] (AgentVerse) and [[P-39]] (HuggingGPT).
