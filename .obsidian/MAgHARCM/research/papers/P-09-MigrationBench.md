...
**Cited by**: [[primitives/Primitives-Index]] entry [[PRIM-3]] (Target Skeleton-First Generation) — MigrationBench's evaluation framework motivates the skeleton-first emit; [[PRIM-5]] (Test Suite Co-Translation & Synthesis) — its "approximate functional equivalence" criterion is the build-and-test proxy
