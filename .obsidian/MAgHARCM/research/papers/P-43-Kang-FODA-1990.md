...
**Cited by**: [[primitives/Primitives-Index]] entry [[PRIM-10]] (Feature-Mapping & Type-Compatibility Validation) — the canonical feature-modeling hop-1 reference.
...
- [[primitives/Primitives-Index]] — [[1.0.0 PRIM-10]] status entry now references [[P-43]] alongside [[P-05]] (Oxidizer) and [[Czarnecki]].
