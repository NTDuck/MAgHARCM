...
aliases:
  - "1.0.0 P-48"
  - "P-48"
  - "P-48-Jia-Harman-Mutation-2011"
  - "P-48-Jia-Harman-Mutation-2011"
  - "Jia-Harman-Mutation-2011"
...
**Cited by**: [[primitives/Primitives-Index]] entry [[PRIM-13]] (Adversarial Test-Weakening Guard) — provides the canonical hop-1 reference for mutation-based adversarial test-quality assessment.
...
- [[primitives/Primitives-Index]] — [[1.0.0 PRIM-13]] status entry now references [[P-48]] alongside [[P-25]] (AdvTestGen) and ISSTA mutation-testing lineage.
