...
aliases:
  - "1.0.0 P-45"
  - "P-45"
  - "P-45-Curtis-Process-Modeling-1992"
  - "P-45-Curtis-Process-Modeling-1992"
  - "Curtis-Process-Modeling-1992"
...
**Cited by**: [[primitives/Primitives-Index]] entry [[PRIM-24]] (SOP-Anchored Role-Artifact Schema) — the canonical process-modelling hop-1 reference for SOP contracts.
...
- [[primitives/Primitives-Index]] — [[1.0.0 PRIM-24]] status entry now references [[P-45]] alongside [[P-11]] (MetaGPT) and Meyer (1988) DbC.
