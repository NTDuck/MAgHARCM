...
aliases:
  - "1.0.0 P-57"
  - "P-57"
  - "P-57-Leviathan-Speculative-Decoding-2023"
  - "P-57-Leviathan-Speculative-Decoding-2023"
  - "Leviathan-Speculative-Decoding-2023"
...
- [[1.0.0 P-68]] (Shazeer 2019) — Fast Transformer Decoding: One Write-Head is All You Need (multi-query attention; related decoding-speedup technique).
...
- [[1.0.0 P-66]] (Howard &amp; Ruder 2018) — ULMFiT (transfer-learning recipe; cited by T5).
