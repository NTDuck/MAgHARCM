...
tags: [primitives, catalog, status, [[1.0.0 PRIM-1]]..[[1.0.0 PRIM-31]], "[[1.0.0 P-122]]", "[[1.0.0 P-123]]", "[[1.0.0 P-124]]", wave-16, wave-17]
---
...
| `[[1.0.0 PRIM-9]]` | Tri-Representation Hybrid Code Graph | `internal/agents/cpg.go` | [[RepoGraph-2024]], Yamaguchi, [[1.0.0 P-110]] GraphCoder / CodeGraphRAG, [[1.0.0 P-124]] Syzygy runtime-mined aliasing/bounds/nullability as fourth representation (wave-17) | implemented |
...
- **Parity**: 31/31/31 unchanged — 31 primitives listed above, 31 implementation files in `internal/agents/*.go` (32 files = 31 impl + 1 test file + 0 orphan).
