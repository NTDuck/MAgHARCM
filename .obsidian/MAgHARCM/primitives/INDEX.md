...
| `[[1.0.0 PRIM-3]]` | Target Skeleton-First Generation | `internal/agents/planning.go::DefaultProjectSkeleton` | [[Skel-2024]], Baldwin & Clark (2000), [[P-42]] DSM (MacCormack 2006) | implemented |
...
| `[[1.0.0 PRIM-14]]` | Software-Archaeology Stage | `internal/agents/archaeology.go` | pp-besm, Chikofsky & Cross (1990), [[P-46]] Seacord et al. (2003) Modernizing Legacy Systems | implemented |
...
| `[[1.0.0 PRIM-24]]` | SOP-Anchored Role-Artifact Schema | `internal/compiletime/compiletime.go`, `internal/agents/state.go` | [[MetaGPT-2023]] SOP Contracts, [[P-45]] Curtis-Kellner-Over (1992) | implemented |
