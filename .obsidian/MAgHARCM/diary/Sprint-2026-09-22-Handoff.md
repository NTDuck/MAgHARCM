...
4 candidates fired:
1. **SWE-bench original** — Jimenez ICLR 2024; 2,294 real GitHub issue/PR pairs across 12 Python repositories. The parent benchmark that SWE-bench Verified (P-109) subsets to 500 human-verified instances. Establishes the PASS-to-PASS + FAIL-to-PASS evaluation criterion that MAgHARCM's [[1.0.0 PRIM-27]] coverage-guided plateau detection anchors against.
