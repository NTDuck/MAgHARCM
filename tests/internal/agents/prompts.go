...
func TestRenderAllPrompts(t *testing.T) {
	// 1. analyzer
	analyzerPrompt, err := agents.RenderPromptTemplate("analyzer", agents.AnalyzerPromptTemplate, map[string]any{
		"SourceLang":         "C",
		"TargetLang":         "Rust",
	...
	// 2. planning
	planningPrompt, err := agents.RenderPromptTemplate("planning", agents.PlanningPromptTemplate, map[string]any{
		"SourceLang":   "C",
		"TargetLang":   "Rust",
	...
	translatePrompt, err := agents.RenderPromptTemplate("translator_translate", agents.TranslatorTranslatePromptTemplate, map[string]any{
	...
	// 4. translator_repair
	repairPrompt, err := agents.RenderPromptTemplate("translator_repair", agents.TranslatorRepairPromptTemplate, map[string]any{
		"PackageName":     "gilded_rose",
		"TargetLang":      "Rust",
		"TargetLangLower": "rust",
	...
	coveragePrompt, err := agents.RenderPromptTemplate("validator_coverage", agents.ValidatorCoveragePromptTemplate, map[string]any{
		"TargetLang":         "Rust",
		"TargetLangLower":    "rust",
