...
\texttt{reasoning: "qwen3:30b-a3b-thinking-2507-q4_K_M"} --- a dense $\sim$20B model. As the project
...
\midrule
\texttt{qwen3:30b-thinking-a1b-q4\_K\_M} & \textbf{8.3B} & \textbf{$\sim$1.5B} & MoE & \textbf{5.2 GB} & Best fit \\
...
\texttt{qwen3:30b-a3b-thinking-2507-q4_K_M} (current default) & $\sim$21B & $\sim$21B & dense (MoE variant) & $\sim$12 GB & \textbf{Current pin} \\
\bottomrule
\end{tabular}
\caption{Local Ollama model candidates for MAgHARCM reasoning slot.}
\end{table}

\texttt{qwen3:30b-thinking-a1b-q4\_K\_M} is the MoE option that delivers 8B-class
...
Replace \texttt{reasoning: "qwen3:30b-a3b-thinking-2507-q4_K_M"} in \texttt{config.yml:12} with
\textbf{\texttt{reasoning: "qwen3:30b-thinking-a1b-q4\_K\_M"}}.
...
\item Quality: pass/fail of the build/test cascade (ReCodeAgent 3-tier
  validation flow from Multi-Stage Build/Test Feedback Repair).
\end{itemize}
...
@@ -9,7 +9,7 @@ translation:
     toolchain: "cargo"
   models:
-    reasoning: "qwen3:30b-a3b-thinking-2507-q4_K_M"
+    reasoning: "qwen3:30b-a3b-thinking-2507-q4_K_M"
...
\midrule
Reasoning & \texttt{qwen3:30b-thinking-a1b-q4\_K\_M} & 5.2 GB & $\sim$1.0 GB & $\sim$6 GB \\
...
\begin{enumerate}
\item Revert \texttt{config.yml:12} to \texttt{qwen3:30b-a3b-thinking-2507-q4_K_M} (or whichever prior
